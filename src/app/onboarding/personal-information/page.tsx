...
export const metadata: Metadata = {
  title: "Personal Information | MITAN",
};
  ...
  return (
    <div className="flex min-h-screen bg-background font-body-md text-on-background antialiased">
      <div className="relative hidden w-1/2 bg-surface-container-highest lg:flex">
        <Image src={IMAGE} alt="A sophisticated architectural photograph of a modern, minimalist Islamic center." fill className="object-cover" priority />
